...
//void SP_monster_dathran(edict_t* self);
...
void SP_worldspawn(edict_t *ent)
{
	...
	//UNSEEN
	PrecacheItem(GetItemByIndex(IT_WEAPON_TBOLT));
	PrecacheItem(GetItemByIndex(IT_WEAPON_YELLOWFLARELAUNCHER));
	PrecacheItem(GetItemByIndex(IT_WEAPON_REDFLARELAUNCHER));
