...
void monster_fire_railgrenade(edict_t* self, const vec3_t& start, const vec3_t& aimdir, int damage, int speed,
	monster_muzzleflash_id_t flashtype, float right_adjust, float up_adjust)
{
	fire_railgrenade(self, start, aimdir, damage, speed, 2.5_sec, damage + 40.f, right_adjust, up_adjust, true);
	monster_muzzleflash(self, start, flashtype);
}
...
void monster_fire_bfgrenade(edict_t* self, const vec3_t& start, const vec3_t& aimdir, int damage, int speed,
	monster_muzzleflash_id_t flashtype, float right_adjust, float up_adjust)
{
	fire_bfgrenade(self, start, aimdir, damage, speed, 2.5_sec, damage + 40.f, right_adjust, up_adjust, true);
	monster_muzzleflash(self, start, flashtype);
}
...
void monster_fire_redflare(edict_t* self, const vec3_t& start, const vec3_t& dir, int damage, int speed,
	monster_muzzleflash_id_t flashtype)
{
	fire_redflare(self, start, dir, damage, speed, (float)damage + 20, damage);
	monster_muzzleflash(self, start, flashtype);
}
...
void monster_fire_yellowflare(edict_t* self, const vec3_t& start, const vec3_t& dir, int damage, int speed,
	monster_muzzleflash_id_t flashtype)
{
	fire_yellowflare(self, start, dir, damage, speed, (float)damage + 20, damage);
	monster_muzzleflash(self, start, flashtype);
}