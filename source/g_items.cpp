...
bool Pickup_Bandolier(edict_t *ent, edict_t *other)
{
	...
	//UNSEEN
	G_AdjustAmmoCap(other, AMMO_TBOLTS, 75);
	G_AdjustAmmoCap(other, AMMO_RAILGRENADES, 25);
	G_AdjustAmmoCap(other, AMMO_BFGRENADES, 5);
	G_AdjustAmmoCap(other, AMMO_GREENFLARES, 40);
	G_AdjustAmmoCap(other, AMMO_YELLOWFLARES, 24);
	G_AdjustAmmoCap(other, AMMO_REDFLARES, 3);
...
bool Pickup_Pack(edict_t *ent, edict_t *other)
{
	...
	//UNSEEN
	G_AdjustAmmoCap(other, AMMO_TBOLTS, 100);
	G_AdjustAmmoCap(other, AMMO_RAILGRENADES, 50);
	G_AdjustAmmoCap(other, AMMO_BFGRENADES, 6);
	G_AdjustAmmoCap(other, AMMO_GREENFLARES, 48);
	G_AdjustAmmoCap(other, AMMO_YELLOWFLARES, 32);
	G_AdjustAmmoCap(other, AMMO_REDFLARES, 4);
...
*/
	...
	*/
	...
	//UNSEEN
	/*QUAKED weapon_tbolt (.3 .3 1) (-16 -16 -16) (16 16 16)
	*/
		{
			/* id */ IT_WEAPON_TBOLT,
			/* classname */ "weapon_toxic_blaster",
			/* pickup */ nullptr,
			/* use */ Use_Weapon,
			/* drop */ nullptr,
			/* weaponthink */ Weapon_Toxic_Blaster,
			/* pickup_sound */ nullptr,
			/* world_model */ nullptr,
			/* world_model_flags */ EF_NONE,
			/* view_model */ "models/weapons/v_blast2/tris.md2",
			/* icon */ "w_blaster",
			/* use_name */  "Toxic Blaster",
			/* pickup_name */  "Toxic Blaster",
			/* pickup_name_definite */ "Toxic Blaster",
			/* quantity */ 1,
			/* ammo */ IT_AMMO_TBOLTS,
			/* chain */ IT_WEAPON_BLASTER,
			/* flags */ IF_WEAPON | IF_STAY_COOP,
...
// UNSEEN
		/*QUAKED weapon_lrs (.3 .3 1) (-16 -16 -16) (16 16 16)
		*/
	{
		/* id */ IT_WEAPON_LONGRANGESHOTGUN,
		/* classname */ "weapon_lrs",
		/* pickup */ Pickup_Weapon,
		/* use */ Use_Weapon,
		/* drop */ Drop_Weapon,
		/* weaponthink */ Weapon_LRS,
		/* pickup_sound */ "misc/w_pkup.wav",
		/* world_model */ "models/weapons/g_lrs/tris.md2",
		/* world_model_flags */ EF_ROTATE | EF_BOB,
		/* view_model */ "models/weapons/v_lrs/tris.md2",
		/* icon */ "w_shotgun",
		/* use_name */  "Long-Range Shotgun",
		/* pickup_name */  "$item_shotgun",
		/* pickup_name_definite */ "$item_shotgun_def",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_SHELLS,
...
// UNSEEN
	/*QUAKED ammo_railgrenades (.3 .3 1) (-16 -16 -16) (16 16 16)
	*/
	{
		/* id */ IT_AMMO_RAILGRENADES,
		/* classname */ "ammo_railgrenades",
		/* pickup */ Pickup_Ammo,
		/* use */ Use_Weapon,
		/* drop */ Drop_Ammo,
		/* weaponthink */ Weapon_RailGrenade,
		/* pickup_sound */ "misc/am_pkup.wav",
		/* world_model */ "models/items/ammo/railgrenades/medium/tris.md2",
		/* world_model_flags */ EF_NONE,
		/* view_model */ "models/weapons/v_railgren/tris.md2",
		/* icon */ "a_railgrenades",
		/* use_name */  "Rail Grenades",
		/* pickup_name */  "$item_grenades",
		/* pickup_name_definite */ "$item_grenades_def",
		/* quantity */ 2,
		/* ammo */ IT_AMMO_RAILGRENADES,
		/* chain */ IT_AMMO_GRENADES,
		/* flags */ IF_AMMO | IF_WEAPON,
		/* vwep_model */ "#a_grenades.md2",
		/* armor_info */ nullptr,
		/* tag */ AMMO_RAILGRENADES,
		/* precaches */ "weapons/rg_hum.wav weapons/hgrent1a.wav weapons/hgrena1b.wav weapons/hgrenc1b.wav weapons/hgrenb1a.wav weapons/hgrenb2a.wav models/objects/railgrenade3/tris.md2",
		/* sort_id */ 0,
		/* quantity_warn */ 2
	},

	/*QUAKED ammo_bfgrenades (.3 .3 1) (-16 -16 -16) (16 16 16)
	*/
	{
		/* id */ IT_AMMO_BFGRENADES,
		/* classname */ "ammo_bfgrenades",
		/* pickup */ Pickup_Ammo,
		/* use */ Use_Weapon,
		/* drop */ Drop_Ammo,
		/* weaponthink */ Weapon_BFGrenade,
		/* pickup_sound */ "misc/am_pkup.wav",
		/* world_model */ "models/items/ammo/bfgrenades/medium/tris.md2",
		/* world_model_flags */ EF_NONE,
		/* view_model */ "models/weapons/v_bfgren/tris.md2",
		/* icon */ "a_bfgrenades",
		/* use_name */  "BFG Grenades",
		/* pickup_name */  "$item_grenades",
		/* pickup_name_definite */ "$item_grenades_def",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_BFGRENADES,
		/* chain */ IT_AMMO_GRENADES,
		/* flags */ IF_AMMO | IF_WEAPON,
		/* vwep_model */ "#a_grenades.md2",
		/* armor_info */ nullptr,
		/* tag */ AMMO_BFGRENADES,
		/* precaches */ "sprites/s_bfg1.sp2 sprites/s_bfg2.sp2 sprites/s_bfg3.sp2 weapons/bfg__f1y.wav weapons/bfg__l1a.wav weapons/bfg__x1b.wav weapons/hgrent1a.wav weapons/hgrena1b.wav weapons/hgrenc1b.wav weapons/hgrenb1a.wav weapons/hgrenb2a.wav models/objects/bfgrenade3/tris.md2",
		/* sort_id */ 0,
		/* quantity_warn */ 2
	},
...
// UNSEEN
	...
	*/
	{
		/* id */ IT_WEAPON_RAILGLAUNCHER,
		/* classname */ "weapon_railgrenadelauncher",
		/* pickup */ Pickup_Weapon,
		/* use */ Use_Weapon,
		/* drop */ Drop_Weapon,
		/* weaponthink */ Weapon_RailGrenadeLauncher,
		/* pickup_sound */ "misc/w_pkup.wav",
		/* world_model */ "models/weapons/g_railaun/tris.md2",
		/* world_model_flags */ EF_ROTATE | EF_BOB,
		/* view_model */ "models/weapons/v_railnch/tris.md2",
		/* icon */ "w_railglauncher",
		/* use_name */  "Rail Grenade Launcher",
		/* pickup_name */  "$item_grenade_launcher",
		/* pickup_name_definite */ "$item_grenade_launcher_def",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_RAILGRENADES,
		...
		/* armor_info */ nullptr,
		/* tag */ 0,
		/* precaches */ "weapons/rg_hum.wav models/objects/railgrenade4/tris.md2 weapons/grenlf1a.wav weapons/grenlr1b.wav weapons/grenlb1b.wav"
	},

	/*QUAKED weapon_bfgrenadelauncher (.3 .3 1) (-16 -16 -16) (16 16 16)
	*/
	{
		/* id */ IT_WEAPON_BFGLAUNCHER,
		/* classname */ "weapon_bfgrenadelauncher",
		/* pickup */ Pickup_Weapon,
		/* use */ Use_Weapon,
		/* drop */ Drop_Weapon,
		/* weaponthink */ Weapon_BFGrenadeLauncher,
		/* pickup_sound */ "misc/w_pkup.wav",
		/* world_model */ "models/weapons/g_bfglaun/tris.md2",
		/* world_model_flags */ EF_ROTATE | EF_BOB,
		/* view_model */ "models/weapons/v_bfglnch/tris.md2",
		/* icon */ "w_bfglauncher",
		/* use_name */  "BFG Grenade Launcher",
		/* pickup_name */  "$item_grenade_launcher",
		/* pickup_name_definite */ "$item_grenade_launcher_def",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_BFGRENADES,
		...
		/* armor_info */ nullptr,
		/* tag */ 0,
		/* precaches */ "sprites/s_bfg1.sp2 sprites/s_bfg2.sp2 sprites/s_bfg3.sp2 weapons/bfg__f1y.wav weapons/bfg__l1a.wav weapons/bfg__x1b.wav models/objects/bfgrenade4/tris.md2 weapons/grenlf1a.wav weapons/grenlr1b.wav weapons/grenlb1b.wav"
	},
...
// UNSEEN
	...
	*/
	{
		/* id */ IT_WEAPON_GREENFLARELAUNCHER,
		/* classname */ "weapon_flarelauncher",
		/* pickup */ Pickup_Weapon,
		/* use */ Use_Weapon,
		/* drop */ Drop_Weapon,
		/* weaponthink */ Weapon_GFlareLauncher,
		/* pickup_sound */ "misc/w_pkup.wav",
		/* world_model */ "models/weapons/g_flareg/tris.md2",
		/* world_model_flags */ EF_ROTATE | EF_BOB,
		/* view_model */ "models/weapons/v_gflareg/tris.md2",
		/* icon */ "w_greenflaregun",
		/* use_name */  "Green Flare Launcher",
		/* pickup_name */  "Green Flare Launcher",
		/* pickup_name_definite */ "Green Flare Launcher",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_GREENFLARES,
		/* chain */ IT_WEAPON_RLAUNCHER,
		/* flags */ IF_WEAPON | IF_STAY_COOP,
		/* vwep_model */ "#w_rlauncher.md2",
		/* armor_info */ nullptr,
	...
	{
		/* id */ IT_WEAPON_YELLOWFLARELAUNCHER,
		/* classname */ "weapon_yflarelauncher",
		/* pickup */ nullptr,
		/* use */ Use_Weapon,
		/* drop */ nullptr,
		/* weaponthink */ Weapon_YFlareLauncher,
		/* pickup_sound */ nullptr,
		/* world_model */ nullptr,
		/* world_model_flags */ EF_NONE,
		/* view_model */ "models/weapons/v_yflareg/tris.md2",
		/* icon */ "w_yellowflaregun",
		/* use_name */  "Yellow Flare Launcher",
		/* pickup_name */  "Yellow Flare Launcher",
		/* pickup_name_definite */ "Yellow Flare Launcher",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_YELLOWFLARES,
		/* chain */ IT_WEAPON_RLAUNCHER,
		/* flags */ IF_WEAPON | IF_STAY_COOP,
		/* vwep_model */ "#w_rlauncher.md2",
		/* armor_info */ nullptr,
	...
	{
		/* id */ IT_WEAPON_REDFLARELAUNCHER,
		/* classname */ "weapon_rflarelauncher",
		/* pickup */ nullptr,
		/* use */ Use_Weapon,
		/* drop */ nullptr,
		/* weaponthink */ Weapon_RFlareLauncher,
		/* pickup_sound */ nullptr,
		/* world_model */ nullptr,
		/* world_model_flags */ EF_NONE,
		/* view_model */ "models/weapons/v_rflareg/tris.md2",
		/* icon */ "w_redflaregun",
		/* use_name */  "Red Flare Launcher",
		/* pickup_name */  "Red Flare Launcher",
		/* pickup_name_definite */ "Red Flare Launcher",
		/* quantity */ 1,
		/* ammo */ IT_AMMO_REDFLARES,
		/* chain */ IT_WEAPON_RLAUNCHER,
		/* flags */ IF_WEAPON | IF_STAY_COOP,
		/* vwep_model */ "#w_rlauncher.md2",
		/* armor_info */ nullptr,
...
// UNSEEN
	{
		/* id */ IT_WEAPON_BFG20K,
		/* classname */ "weapon_bfg20k",
		/* pickup */ Pickup_Weapon,
		/* use */ Use_Weapon,
		/* drop */ Drop_Weapon,
		/* weaponthink */ Weapon_BFG20K,
		/* pickup_sound */ "misc/w_pkup.wav",
		/* world_model */ "models/weapons/g_bfg20k/tris.md2",
		/* world_model_flags */ EF_ROTATE | EF_BOB,
		/* view_model */ "models/weapons/v_bfg20k/tris.md2",
		/* icon */ "w_bfg20k",
		/* use_name */  "BFG20K",
		/* pickup_name */  "$item_bfg10k",
		/* pickup_name_definite */ "$item_bfg10k_def",
...
// =======================================
// UNSEEN
	/*QUAKED ammo_tbolts (.3 .3 1) (-16 -16 -16) (16 16 16)
	*/
	{
		/* id */ IT_AMMO_TBOLTS,
		/* classname */ "ammo_tbolts",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
		/* pickup_sound */ "misc/am_pkup.wav",
		/* world_model */ "models/items/ammo/poison/medium/tris.md2",
		/* world_model_flags */ EF_NONE,
		/* view_model */ nullptr,
		/* icon */ "a_tbolts",
		/* use_name */  "Toxic Bolts",
		/* pickup_name */  "Toxic Bolts",
		/* pickup_name_definite */ "Toxic Bolts",
		/* quantity */ 10,
		/* ammo */ IT_NULL,
		/* chain */ IT_NULL,
		/* flags */ IF_AMMO,
	...
	/*QUAKED ammo_greenflares (.3 .3 1) (-16 -16 -16) (16 16 16)
	*/
	{
		/* id */ IT_AMMO_GREENFLARES,
		/* classname */ "ammo_greenflares",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
		/* pickup_sound */ "misc/am_pkup.wav",
		/* world_model */ "models/items/ammo/gflares/medium/tris.md2",
		/* world_model_flags */ EF_NONE,
		/* view_model */ nullptr,
		/* icon */ "a_greenflares",
		/* use_name */  "Green Flares",
		/* pickup_name */  "$item_bullets",
		/* pickup_name_definite */ "$item_bullets_def",
		/* quantity */ 8,
		/* ammo */ IT_NULL,
		...
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ AMMO_GREENFLARES
	},

	/*QUAKED ammo_yellowflares (.3 .3 1) (-16 -16 -16) (16 16 16)
	*/
	{
		/* id */ IT_AMMO_YELLOWFLARES,
		/* classname */ "ammo_yellowflares",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
		/* pickup_sound */ "misc/am_pkup.wav",
		/* world_model */ "models/items/ammo/yflares/medium/tris.md2",
		/* world_model_flags */ EF_NONE,
		/* view_model */ nullptr,
		/* icon */ "a_yellowflares",
		/* use_name */  "Yellow Flares",
		/* pickup_name */  "$item_bullets",
		/* pickup_name_definite */ "$item_bullets_def",
		/* quantity */ 4,
		/* ammo */ IT_NULL,
		...
		/* vwep_model */ nullptr,
		/* armor_info */ nullptr,
		/* tag */ AMMO_YELLOWFLARES
	},

	/*QUAKED ammo_redflares (.3 .3 1) (-16 -16 -16) (16 16 16)
	*/
	{
		/* id */ IT_AMMO_REDFLARES,
		/* classname */ "ammo_redflares",
		/* pickup */ Pickup_Ammo,
		/* use */ nullptr,
		/* drop */ Drop_Ammo,
		/* weaponthink */ nullptr,
		/* pickup_sound */ "misc/am_pkup.wav",
		/* world_model */ "models/items/ammo/rflares/medium/tris.md2",
		/* world_model_flags */ EF_NONE,
		/* view_model */ nullptr,
		/* icon */ "a_redflares",
		/* use_name */  "Red Flares",
...
//UNSEEN
void SP_item_unseen(edict_t* self)
{
	SpawnItem(self, GetItemByIndex(IT_ITEM_INVISIBILITY), ED_GetSpawnTemp());
}