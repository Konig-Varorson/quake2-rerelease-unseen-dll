...
enum item_id_t : int32_t {
	...
	IT_WEAPON_BLASTER,
	IT_WEAPON_CHAINFIST,
	IT_WEAPON_TBOLT, //UNSEEN
	IT_WEAPON_SHOTGUN,
	IT_WEAPON_LONGRANGESHOTGUN, //UNSEEN
	IT_WEAPON_SSHOTGUN,
	...
	IT_AMMO_TRAP,
	IT_AMMO_TESLA,
	IT_AMMO_RAILGRENADES, //UNSEEN
	IT_AMMO_BFGRENADES, //UNSEEN
	IT_WEAPON_GLAUNCHER,
	IT_WEAPON_PROXLAUNCHER,
	IT_WEAPON_RAILGLAUNCHER, //UNSEEN
	IT_WEAPON_BFGLAUNCHER, //UNSEEN
	IT_WEAPON_RLAUNCHER,
	IT_WEAPON_GREENFLARELAUNCHER, //UNSEEN
	IT_WEAPON_YELLOWFLARELAUNCHER, //UNSEEN
	IT_WEAPON_REDFLARELAUNCHER, //UNSEEN
...
void monster_fire_bfgrenade(edict_t* self, const vec3_t& start, const vec3_t& aimdir, int damage, int speed,
							monster_muzzleflash_id_t flashtype, float right_adjust, float up_adjust);
void monster_fire_redflare(edict_t* self, const vec3_t& start, const vec3_t& dir, int damage, int speed,
							monster_muzzleflash_id_t flashtype);
void monster_fire_yellowflare(edict_t* self, const vec3_t& start, const vec3_t& dir, int damage, int speed,
							monster_muzzleflash_id_t flashtype);
